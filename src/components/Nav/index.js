...
return(
        <ul className="nav nav-fill justify-content-center text-light">
          <li className="nav-item">
            <a href="#about" onClick={() => handlePageChange('About')} className={currentPage === 'About' ? 'nav-link active active-hover text-success text-decoration-underline fw-bold lead' : 'nav-link lead text-light'}>About</a>
          </li>
          <li className="nav-item">
